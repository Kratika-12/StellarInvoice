...
function CreateInvoicePage() {
  ...
  return (
    <AppShell>
      <div className="relative mx-auto max-w-5xl py-6 sm:py-10">
          ...
          {invoice ? (
            ...
            <div className="mt-8 grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_19rem]">
              <form
                onSubmit={onSubmit}
                aria-busy={creating}
                className="rounded-[2rem] bg-card p-5 shadow-[var(--shadow-lift)] ring-1 ring-border sm:p-8"
              >
                <div className="flex items-start justify-between gap-4 border-b border-border pb-6">
                  <div>
                    <h2 className="text-xl font-extrabold">Invoice details</h2>
                ...
                {formError && (
                  <div
                    id="form-error"
                    role="alert"
                    className="mt-6 rounded-2xl bg-destructive/10 p-4 text-sm font-bold text-destructive"
                  >
                    {formError}
                  </div>
                )}
                ...
                <div className="mt-6 space-y-6">
                  <Field
                    ...
                    htmlFor="amount"
                  >
                    <div className="flex min-h-16 items-center rounded-2xl bg-secondary/60 px-4 ring-1 ring-border focus-within:ring-2 focus-within:ring-primary">
                      <input
                        id="amount"
                        value={amount}
                        ...
                        required
                        placeholder="0.00"
                        className="min-w-0 flex-1 bg-transparent text-3xl font-extrabold tracking-tight outline-none placeholder:text-muted-foreground/50"
                      />
                      <span className="rounded-full bg-card px-3 py-1.5 text-sm font-extrabold text-primary ring-1 ring-border">
                        XLM
                      </span>
                    </div>
                  </Field>
                  ...
                  <Field
                    ...
                    htmlFor="description"
                  >
                    <div className="flex items-start gap-3 rounded-2xl bg-secondary/60 px-4 py-3 ring-1 ring-border focus-within:ring-2 focus-within:ring-primary">
                      <FileText
                      ...
                      <textarea
                        ...
                        className="min-h-20 w-full resize-none bg-transparent font-semibold outline-none placeholder:text-muted-foreground/60"
                      />
                    </div>
                  ...
                  <Field
                    ...
                    htmlFor="due-date"
                  >
                    <div className="flex min-h-12 items-center gap-3 rounded-2xl bg-secondary/60 px-4 ring-1 ring-border focus-within:ring-2 focus-within:ring-primary">
                      <CalendarDays
                ...
                <button
                  ...
                  disabled={creating}
                  aria-busy={creating}
                  className="mt-8 inline-flex min-h-14 w-full items-center justify-center gap-2 rounded-2xl bg-primary px-6 py-4 text-lg font-extrabold text-primary-foreground shadow-[var(--shadow-soft)] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 motion-safe:transition-transform motion-safe:duration-150 motion-safe:ease-out motion-safe:hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-70"
                >
                  {creating ? (
                    <>
                    ...
                    <>
                      Create & share invoice <ArrowRight className="h-5 w-5" aria-hidden="true" />
                    </>
                  )}
                </button>
              ...
              <aside className="space-y-4 lg:sticky lg:top-28">
                ...
                <div className="flex gap-3 rounded-3xl bg-primary/10 p-4 text-sm text-foreground">
...
function Field({
  ...
  return (
    <div>
      <label htmlFor={htmlFor} className="text-sm font-extrabold text-foreground">
